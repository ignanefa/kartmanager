...
import { createArchivo, deleteArchivo, updateArchivoPublicado } from './actions'
    ...
    <div>
      ...
      <div className="mt-4 space-y-2">
        ...
        {archivos?.map((a) => (
          <div
            key={a.id}
            className="flex flex-wrap items-center justify-between gap-3 rounded-lg bg-white px-4 py-3 ring-1 ring-gray-200"
          >
